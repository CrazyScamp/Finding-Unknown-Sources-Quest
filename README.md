...
## Recommended
Use a Launcher.
Launchers are apps that replace the default Library view, showing all your pirated and purchased games together with cover art, sorting, and organization. The first few items listed in Rookie are launchers — install one and pin it to your Quest main menu bar for one-click access to everything.
